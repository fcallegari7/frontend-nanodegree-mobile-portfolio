...
Creator:
Fabio It, Udacity Course Developer
...
var selectRandomMeat = function () {
  var randomMeat =
    pizzaIngredients.meats[
      Math.floor(Math.random() * pizzaIngredients.meats.length)
    ];
  return randomMeat;
};
...
var selectRandomNonMeat = function () {
  var randomNonMeat =
    pizzaIngredients.nonMeats[
      Math.floor(Math.random() * pizzaIngredients.nonMeats.length)
    ];
...
var selectRandomCheese = function () {
  var randomCheese =
    pizzaIngredients.cheeses[
      Math.floor(Math.random() * pizzaIngredients.cheeses.length)
    ];
  return randomCheese;
};
...
var selectRandomSauce = function () {
  var randomSauce =
    pizzaIngredients.sauces[
      Math.floor(Math.random() * pizzaIngredients.sauces.length)
    ];
  return randomSauce;
};
...
var selectRandomCrust = function () {
  var randomCrust =
    pizzaIngredients.crusts[
      Math.floor(Math.random() * pizzaIngredients.crusts.length)
    ];
  return randomCrust;
};
